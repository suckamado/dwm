...
static const char *fonts[]          = { "Inconsolata:size=14" , "fontawesome:size=12" };
...
static const char col_cyan2[]       = "#6E6E6E";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_cyan, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray1, col_cyan,  col_cyan2  },
};
...
static const char *filemgr[]  = { "/bin/pcmanfm", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,             		XK_c, 	   spawn,          SHCMD("~/.suckless/scripts/calc.sh") },
	{ MODKEY,                       XK_z,      spawn,          SHCMD("~/.suckless/scripts/energy.sh") },
